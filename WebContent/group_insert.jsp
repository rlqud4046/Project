...
<body>
	...
	<form action="group_insert_ok.do">
		<div align="center">
			...
			<input type="text" value="" name="select_l_category" id="select_l_category">
			<input type="text" value="" name="select_s_category" id="select_s_category" required="required">
			...
			<input type="text" value="" name="select_city" id="select_city">
			<input type="text" value="" name="select_town" id="select_town" required="required">
			<br/>
