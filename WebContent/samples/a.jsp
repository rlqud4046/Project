   ...
   <div align="center">
      ...
      <ul class="nav nav-tabs" role="tablist" id="myTab">
         <li role="presentation" class="active"><a href="#home"
            aria-controls="home" role="tab" data-toggle="tab"><img alt="홈" src="images/home.png" width="30px"></a></li>
         <li role="presentation"><a href="#notice"
            aria-controls="home" role="tab" data-toggle="tab">공지사항</a></li>
      ...
      <div class="tab-content">
         <div role="tabpanel" class="tab-pane active" id="home">홈</div>
         <div role="tabpanel" class="tab-pane active" id="notice">공지사항 게시판</div>
